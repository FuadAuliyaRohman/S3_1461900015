        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="example">
                            <input type="text" placeholder="Filter Nama Guru" name="search">
                            <button type="submit">Filter Nama Guru</button>
                        </form>
                        <button type="button" style="margin-buttom: 10px ;margin-top: 10px;" onclick="location.href='{{ url('tugas_praktikum3/create') }}'" class="btn btn-primary">Tambah Guru</button>
                        <br>
                        <table data-toggle="table">
                        <thead>
                        <tr>
